...
const STEPS = [
  ...
  },
  {
    ...
    type: 'single' as const,
    options: [
      { label: '冷峻精密', sub: '克制 · 留白 · 单色 — Apple / Vercel / Arc', value: 'minimal-precision：冷峻精密，大量留白，几何无衬线，近乎无色的单色调，每个元素都有存在理由' },
      { label: '温暖亲和', sub: '温度 · 有机 · 大地色 — Airbnb / Notion / Loom', value: 'warm-humanist：温暖亲和，有机感，大地暖色，衬线或柔和无衬线字体，让人放松' },
      { label: '暗色科技', sub: '深底 · 渐变光晕 · 层次感 — Stripe / Cursor / Cosmos', value: 'dark-tech：深色背景，渐变光晕，高对比，技术先锋感，层次丰富，现代几何字体' },
      { label: '东方禅意', sub: '留白即设计 · 内敛 · 水墨 — Muji / 少数派 / 得到', value: 'eastern-zen：东方禅意，留白即设计，水墨气质，内敛克制，方正细体，减法美学' },
      { label: '活力撞色', sub: '高饱和 · 大胆配色 · 紧凑 — Duolingo / Figma / Framer', value: 'playful-bold：活力撞色，高饱和，不怕出错，粗壮有性格字体，紧凑有节奏感' },
      { label: '专业可信', sub: '结构清晰 · 蓝色系 · 稳重 — Atlassian / Salesforce / Workday', value: 'professional-trust：专业可信，蓝色系，结构清晰，信息层级严谨，可靠稳重，低饱和' },
      { label: '无声奢华', sub: '米白质感 · 极少文字 · 留白 — Hermès / The Row / Bottega', value: 'quiet-luxury：无声奢华，米白燕麦色，大量留白，极少文字，细衬线宽字距，物质质感强' },
      { label: '工业美学', sub: '哑光质感 · 功能至上 · 精准 — Braun / Dyson / Teenage Eng', value: 'industrial-craft：工业美学，哑光灰黑，产品为主角，等宽工程感字体，功能主义，形式服从功能' },
    ],
  },
  {
    id: 'emotion',
    ...
    options: [
      ...
      { label: '高效，直接搞定', sub: '快速 · 无摩擦 · 省时间 — Raycast / Vercel / Clerk', value: '高效直接，无摩擦，节省时间' },
