...
const TOOLS = [
  ...
  },
  {
    ...
    icon: '◇',
    name: '插图风格',
    nameEn: 'Illustration Style',
    desc: '上传参考插图，AI 提取笔触、配色、构图语言，生成可复用的风格描述与同风格插图。',
    features: ['风格提取', '参考分析', 'AI 生成'],
    available: false,
    href: undefined,
    cta: '即将推出',
    cardBg: 'linear-gradient(to bottom, #ebebeb 0%, #f0f0f0 50%, #e8e8e8 100%)',
    textColor: 'var(--muted)',
